...
namespace TASMod
{
    public class Constants
    {
        ...
        public static readonly string ExportsPath;
        ...
        static Constants()
        {
            ...
            BasePath = mkdir(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "StardewTAS1.6");
            SavesPath = mkdir(BasePath, "Saves");
            ScreenshotPath = mkdir(BasePath, "Screenshots");
            ProfilingPath = mkdir(BasePath, "Profiling");
            ExportsPath = mkdir(BasePath, "Exports");
