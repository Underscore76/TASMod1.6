...
//             if (!sortByScore)
//             {
//                 return terms.Where((string term) => Utility.fuzzyCompare(query, term).HasValue).OrderBy((string term) => term.ToLowerInvariant());
//             }
//             return terms.Select((string term) => new
//             {
//                 term = term,
//                 score = Utility.fuzzyCompare(query, term)
//             }).Where(_003C_003Eh__TransparentIdentifier0 => _003C_003Eh__TransparentIdentifier0.score.HasValue).OrderBy(_003C_003Eh__TransparentIdentifier0 => _003C_003Eh__TransparentIdentifier0.score.Value)
//                 .ThenBy(_003C_003Eh__TransparentIdentifier0 => _003C_003Eh__TransparentIdentifier0.term.ToLowerInvariant())
//                 .Select(_003C_003Eh__TransparentIdentifier0 => _003C_003Eh__TransparentIdentifier0.term);
//         }
...
//                 }
//                 int farmerNumber = 2;
//                 foreach (Farmer item in Game1.otherFarmers.Values.OrderBy((Farmer f) => f.UniqueMultiplayerID).Where((Farmer f) => !f.IsMainPlayer))
//                 {
...
//             }
//             int curNumber = 2;
//             foreach (Farmer player in Game1.otherFarmers.Values.OrderBy((Farmer f) => f.UniqueMultiplayerID).Where((Farmer f) => !f.IsMainPlayer))
//             {
//                 if (curNumber == number)
//                 {
//                     return player;
...
//                     {
//                         building3.GetIndoors()?.animals.RemoveWhere((KeyValuePair<long, FarmAnimal> pair) => pair.Value.Equals(a2));
//                     }
...
//                     ownerData = owners.OrderByDescending((ShopOwnerData p) => p.Type == ShopOwnerType.NamedNpc).ThenByDescending((ShopOwnerData p) => p.Type != ShopOwnerType.None).FirstOrDefault((ShopOwnerData p) => p.IsValid(ownerName));
//                     break;
//             }
...
//                 Vector2[] array = Utility.getAdjacentTileLocations(current).OrderBy((Vector2 a) => Guid.NewGuid()).ToArray();
