...
//                             if (levelsNotSpent > 0 && mastery == 0)
//                             {
//                                 this.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Microsoft.Xna.Framework.Rectangle(16, 110, 7, 9), spritePosition * 4f, flipped: false, 0f, Color.White)
//                                 {
//                                     animationLength = 15,
//                                     interval = 50f,
...
//                 {
//                     if (this.objects.TryGetValue(corner, out var value) && value != null)
//                     {
//                         if (value.isPassable())
//                         {
//                             return false;
...
//                     return false;
//                 });
//                 if (this._TestCornersTiles(nextTopRight, nextTopLeft, nextBottomRight, nextBottomLeft, nextTopMid, nextBottomMid, currentTopRight, currentTopLeft, currentBottomRight, currentBottomLeft, currentTopMid, currentBottomMid, nextLargerThanTile, (Vector2 corner) => (this.terrainFeatures.TryGetValue(corner, out var value3) && value3 != null && value3.getBoundingBox().Intersects(position) && !value3.isPassable(character)) ? true : false))
//                 {
//                     return true;
//                 }
//             }
...
//                         {
//                             return !passableTiles.Contains((int)tile.X, (int)tile.Y);
//                         }
//                         return true;
//                     }))
//                     {
...
//                     Tile tile4 = buildings_layer.Tiles[tileLocation.X, tileLocation.Y];
...
//                         tile4 = buildings_layer.Tiles[tileLocation.X, tileLocation.Y];
//                         if (tile4 != null && tile4.Properties.ContainsKey("Action"))
//                         {
//                             this.openDoor(new Location(tileLocation.X, tileLocation.Y), Game1.currentLocation.Equals(this));
//                         }
...
//                 if ((!(t3?.TileIndexProperties.ContainsKey("Water"))) ?? true)
//                 {
//                     int num = (int)tile.X;
//                     int num2 = (int)tile.Y;
...
//                                             break;
//                                         }
//                                         for (int k = 1; k < action.Length && (!(action[k] == "Sebastian") || !this.IsGreenRainingHere() || Game1.year != 1); k++)
//                                         {
//                                             if (Game1.player.getFriendshipHeartLevelForNPC(action[k]) < 2 && k == action.Length - 1)
//                                             {
...
//                                                 break;
//                                             }
//                                             if (k != action.Length - 1 && Game1.player.getFriendshipHeartLevelForNPC(action[k]) >= 2)
//                                             {
//                                                 Game1.player.mailReceived.Add("doorUnlock" + action[k]);
//                                                 break;
//                                             }
//                                             if (k == action.Length - 1 && Game1.player.getFriendshipHeartLevelForNPC(action[k]) >= 2)
//                                             {
...
//             {
//                 TerrainFeature feature2 = this._activeTerrainFeatures[i2];
//                 if (feature2.tickUpdate(time))
//                 {
//                     this.terrainFeatures.Remove(feature2.Tile);
//                 }
//             }
//             this.largeTerrainFeatures?.RemoveWhere((LargeTerrainFeature feature) => feature.tickUpdate(time));
//             foreach (ResourceClump resourceClump in this.resourceClumps)
//             {
...
//             {
//                 array[i].dayUpdate(this);
//             }
//             for (int i2 = this.debris.Count - 1; i2 >= 0; i2--)
//             {
//                 Debris d2 = this.debris[i2];
...
//             {
//                 if (pair3.Value is HoeDirt hoe_dirt)
//                 {
...
//             }
//             this.objects.Lock();
//             foreach (KeyValuePair<Vector2, Object> pair4 in this.objects.Pairs)
//             {
//                 pair4.Value.DayUpdate();
//                 if (pair4.Value.destroyOvernight)
//                 {
//                     pair4.Value.performRemoveAction();
...
//                     {
//                         KeyValuePair<Vector2, Object> pair5 = array4[i];
//                         if (pair5.Value.isSpawnedObject.Value && pair5.Value.SpecialVariable != 724519 && !ignoreRectangle.Contains(Utility.Vector2ToPoint(pair5.Key)))
//                         {
//                             this.objects.Remove(pair5.Key);
//                         }
//                     }
...
//                 }
//             }
//             this.terrainFeatures.RemoveWhere((KeyValuePair<Vector2, TerrainFeature> pair) => pair.Value is HoeDirt hoeDirt && (hoeDirt.crop == null || hoeDirt.crop.forageCrop.Value) && (!this.objects.TryGetValue(pair.Key, out var value) || value == null || !value.IsSpawnedObject || !value.isForage()) && Game1.random.NextBool(this.GetDirtDecayChance(pair.Key)));
...
//         {
//             if (this.map != null && this.Map.Properties.TryGetValue(propertyName, out string rawValue))
//             {
//                 if (rawValue == null)
//                 {
//                     return false;
...
//                     {
//                         if (!ArgUtility.TryGetPoint(windowLights, j, out var tile2, out var error2, "Point tile") || !ArgUtility.TryGetInt(windowLights, j + 2, out var textureIndex2, out error2, "int textureIndex"))
//                         {
...
//                 {
//                     if (!ArgUtility.TryGetVector2(sounds, k, out var tile3, out var error3, integerOnly: false, "Vector2 tile") || !ArgUtility.TryGetInt(sounds, k + 2, out var soundId, out error3, "int soundId"))
//                     {
...
//                 {
//                     if (!ArgUtility.TryGet(dayTiles, l, out var layerId, out var error4, allowBlank: true, "string layerId") || !ArgUtility.TryGetPoint(dayTiles, l + 1, out var position, out error4, "Point position") || !ArgUtility.TryGetInt(dayTiles, l + 3, out var tileIndex, out error4, "int tileIndex"))
//                     {
...
//                         for (int i = 0; i < 3; i++)
//                         {
//                             this.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(372, 1956, 10, 10), tile * 64f + new Vector2(i * 6, -3 + garbageRandom.Next(3)) * 4f, flipped: false, 0.02f, Color.DimGray)
//                             {
//                                 alpha = 0.85f,
...
//                         for (int k = 0; k < squidTargets.Length; k++)
//                         {
//                             if (currentSquid < squidTargets[k])
//                             {
//                                 continue;
//                             }
//                             if (!Game1.player.mailReceived.Contains("GotSquidFestReward_" + Game1.year + "_" + Game1.dayOfMonth + "_" + k))
//                             {
//                                 availableRewards.Add(Game1.dayOfMonth + "_" + k);
//                                 Game1.player.mailReceived.Add("GotSquidFestReward_" + Game1.year + "_" + Game1.dayOfMonth + "_" + k);
//                                 alreadyReceivedAllRewards = false;
//                                 if (!alreadyGotCrabbingBook && k >= 3)
//                                 {
...
//                         Game1.drawObjectDialogue(Game1.content.LoadString("Strings\\Locations:Sewer_DogStatueFinished"));
//                         int num7 = Farmer.checkForLevelGain(0, Game1.player.experiencePoints[2]);
//                         if (num7 >= 5)
//                         {
...
//                                 delayBeforeAnimationStart = num5 * 25
//                             });
//                         }
...
//                         {
//                             foreach (Vector2 v2 in Utility.getBorderOfThisRectangle(Utility.getRectangleCenteredAt(new Vector2(7f, 5f), 2 + num4 * 2)))
//                             {
//                                 if (count % 2 == 0)
//                                 {
...
//                                     {
//                                         layerDepth = 1f,
//                                         delayBeforeAnimationStart = num4 * 50,
//                                         scale = 4f,
//                                         scaleChange = 1f,
//                                         color = new Color(255 - Utility.getRedToGreenLerpColor(1f / (float)(num4 + 1)).R, 255 - Utility.getRedToGreenLerpColor(1f / (float)(num4 + 1)).G, 255 - Utility.getRedToGreenLerpColor(1f / (float)(num4 + 1)).B),
...
//                             {
//                                 delayBeforeAnimationStart = 500 + j * 25,
...
//                                 scaleChange = 0.01f,
//                                 rotationChange = (float)Game1.random.Next(-5, 6) * (float)Math.PI / 256f,
//                                 delayBeforeAnimationStart = num8 * 25
//                             });
//                         }
...
//                         for (int m = 0; m < Game1.player.maxItems.Value; m++)
//                         {
...
//                     {
//                         NPC n3 = this.getCharacterFromName("Clint");
//                         if (n3 != null)
//                         {
...
//             }
//             possibleFish = possibleFish.OrderBy((SpawnFishData p) => p.Precedence).ThenBy((SpawnFishData p) => Game1.random.Next());
...
//                 else
//                 {
//                     if (!ArgUtility.TryGetInt(specificFishData, 1, out var difficulty, out var error2, "int difficulty"))
//                     {
...
//             if (isTutorialCatch)
//             {
//                 if (!ArgUtility.TryGetOptionalBool(specificFishData, 13, out var isTutorialFish, out var error3, defaultValue: false, "bool isTutorialFish"))
//                 {
...
//                 if (!usingMagicBait)
//                 {
//                     if (!ArgUtility.TryGet(specificFishData, 5, out var rawTimeSpans, out var error4, allowBlank: true, "string rawTimeSpans"))
//                     {
...
//                     {
//                         if (!ArgUtility.TryGetInt(timeSpans, i, out var startTime, out error4, "int startTime") || !ArgUtility.TryGetInt(timeSpans, i + 1, out var endTime, out error4, "int endTime"))
//                         {
//                             return LogFormatError("invalid time spans '" + rawTimeSpans + "': " + error4);
//                         }
...
//                 if (!usingMagicBait)
//                 {
//                     if (!ArgUtility.TryGet(specificFishData, 7, out var weather, out var error5, allowBlank: true, "string weather"))
//                     {
...
//                     }
//                 }
//                 if (!ArgUtility.TryGetInt(specificFishData, 12, out var minFishingLevel, out var error6, "int minFishingLevel"))
//                 {
...
//                     return false;
//                 }
//                 if (!ArgUtility.TryGetInt(specificFishData, 9, out var maxDepth, out var error7, "int maxDepth") || !ArgUtility.TryGetFloat(specificFishData, 10, out var chance, out error7, "float chance") || !ArgUtility.TryGetFloat(specificFishData, 11, out var depthMultiplier, out error7, "float depthMultiplier"))
//                 {
...
//                     if (tile == null || !tile.Properties.TryGetValue("Action", out string door) || !door.Contains("Warp"))
//                     {
//                         continue;
//                     }
...
//             try
//             {
//                 if (!this.map.Properties.TryGetValue(propertyName, out string oldValue))
//                 {
