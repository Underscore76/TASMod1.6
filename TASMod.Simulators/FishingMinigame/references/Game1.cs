...
//                     if (!found)
//                     {
//                         Object item2 = ItemRegistry.Create<Object>("(O)864");
//                         item2.specialItem = true;
//                         item2.questItem.Value = true;
//                         if (!player.addItemToInventoryBool(item2))
//                         {
...
//                 {
//                     Item item3 = current2.item;
//                     if (item3 != null)
//                     {
//                         foreach (Type current3 in missingTools.Keys)
//                         {
//                             if (item3.GetType() == current3)
//                             {
//                                 list.Add(current2);
//                             }
//                         }
...
//                     order2.Add(j);
//                 }
//                 Utility.Shuffle(Utility.CreateRandom(Game1.uniqueIDForThisGame), order2);
...
//                         {
//                             if (pair3.Value is HoeDirt hoeDirt && hoeDirt.state.Value != 2)
//                             {
...
//                 return;
//             }
//             foreach (Farmer farmer2 in Game1.getOnlineFarmers().OrderBy((Farmer farmer) => farmer.UniqueMultiplayerID))
//             {
...
//             {
//                 GameLocation location = Game1.locations[j];
...
//                     try
//                     {
//                         Game1.locations[j] = Activator.CreateInstance(location.GetType(), args) as GameLocation;
//                     }
//                     catch
//                     {
//                         Game1.locations[j] = Activator.CreateInstance(location.GetType()) as GameLocation;
//                     }
//                     Game1._locationLookup.Clear();
//                 }
//             }
...
//             {
//                 if (stable2.owner.Value == -6666666 && Game1.GetPlayer(-6666666L) == null)
//                 {
//                     stable2.owner.Value = Game1.player.UniqueMultiplayerID;
//                 }
//                 stable2.grabHorse();
//             }
...
//                 {
//                     stable3.owner.Value = owner.UniqueMultiplayerID;
...
//             {
//                 Horse horse4 = stable5.getStableHorse();
...
//                     {
//                         stable5.owner.Value = 0L;
//                         stable5.updateHorseOwnership();
//                         if (verbose)
//                         {
...
//             {
//                 value.RemoveWhere((Item item) => this._RecursiveRemoveThisNormalItemItem(item, itemId));
//             }
