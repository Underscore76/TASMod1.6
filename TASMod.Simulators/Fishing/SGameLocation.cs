...
namespace TASMod.Simulators.Fishing
{
    public class SGameLocation
    {
        ...
        public SGameLocation GetParentLocation()
        {
            if (parentLocationName == null)
            {
                return null;
            }
            return sgame.getLocationFromName(parentLocationName);
        }
        ...
        {
            return sgame.netWorldState.Value.GetWeatherForLocation(GetLocationContextId());
        }
        ...
        public virtual void UpdateWhenCurrentLocation(GameTime time, Random Game1_random)
        {

        }

        public virtual void updateEvenIfFarmerIsntHere(GameTime time, Random Game1_random)
        {
