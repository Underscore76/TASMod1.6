...
namespace TASMod.Helpers
{
    public class CurrentMenu
    {
        ...
        {
            get { return Game1.activeClickableMenu != null; }
        }

        public static IClickableMenu Menu
        {
            get { return Game1.activeClickableMenu; }
        }
        ...
        // Save Game functions
        public static bool IsSaveGame
        {
            get { return Game1.activeClickableMenu is SaveGameMenu; }
        }
        public static bool CanQuit
        {
            get { return (Game1.activeClickableMenu as SaveGameMenu).quit; }
        }

        // Dialogue Box functions
        public static bool IsDialogue
        {
            get { return Game1.activeClickableMenu is DialogueBox; }
        }
        public static bool Transitioning
        {
            get { return (Game1.activeClickableMenu as DialogueBox).transitioning; }
        }
        public static bool IsQuestion
        {
            get { return (Game1.activeClickableMenu as DialogueBox).isQuestion; }
        }
        public static int CharacterIndexInDialogue
        {
            get { return (Game1.activeClickableMenu as DialogueBox).characterIndexInDialogue; }
        }
        ...
        public static Dictionary<string, bool> GetPageRecipes(CraftingPage page)
        {
            ...
            List<Item> containerContents = Reflector.InvokeMethod<CraftingPage, List<Item>>(
                page,
                "getContainerContents"
            );
            Dictionary<string, bool> recipes = new Dictionary<string, bool>();
            foreach (
                ClickableTextureComponent key in page.pagesOfCraftingRecipes[
                    currentCraftingPage
                ].Keys
            )
            {
                ...
                recipes.Add(
                    name,
                    page.pagesOfCraftingRecipes[currentCraftingPage][key]
                        .doesFarmerHaveIngredientsInInventory(containerContents)
                );
            }
            return recipes;
        }
