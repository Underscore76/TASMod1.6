...
namespace TASMod.Helpers
{
    public class Globals
    {
        ...
        {
            get { return new Vector2(Game1.viewport.Width / 2, Game1.viewport.Height / 2); }
        }
        ...
        {
            get { return Game1.globalFade; }
        }
        public static bool FadeIn
        {
            get { return Game1.fadeIn; }
        }
        public static bool FadeToBlack
        {
            get { return Game1.fadeToBlack; }
        }
        public static float FadeToBlackAlpha
        {
            get { return Game1.fadeToBlackAlpha; }
        }
    }
}
